...
app.get('/logout',function (req,res){
   ...
   res.send('<html><body></br><div align="container container-fluid"><div class="jumbotron"><h1 class="lead">Logged out!</h1><br/><br/><a href="/">Back to home</a> </div> </div></body></html>');
